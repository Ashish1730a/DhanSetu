  ...
  return (
    <>
      ...
      <RightImage imageURL="media/kiteconnect.png"
        ...
        productDesctiption="Build powerful trading platforms and experiences with our super simple HTTP/JSON APIs. If you are a startup, build your investment app and showcase it to our clientbase."
      ...
      <LeftImage
        ...
        appStore=" "
      />
      <p className="text-center mt-3 mb-3">Want to know more about our technology stack? Check out the <a href="https://zerodha.tech" style={{textDecoration: "none"}}>DhanSetu.tech</a> blog.</p>
      <Universe />
    </>
  );
}
